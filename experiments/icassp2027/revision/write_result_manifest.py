...
def main() -> int:
    if len(sys.argv) != 4:
        print(
            "usage: write_result_manifest.py PATH FINAL_EXIT TRAINING_EXIT",
            file=sys.stderr,
        )
        return 2
    ...
    payload = {
        ...
        "paper_component_recipe_path": _env("PAPER_COMPONENT_RECIPE_PATH") if condition == "full_attnres_only" else "",
        "paper_component_recipe_id": _env("PAPER_COMPONENT_RECIPE_ID") if condition == "full_attnres_only" else "",
        "paper_component_recipe_sha256": _env("PAPER_COMPONENT_RECIPE_SHA256") if condition == "full_attnres_only" else "",
        "paper_component_semantics_sha256": _env("PAPER_COMPONENT_SEMANTICS_SHA256") if condition == "full_attnres_only" else "",
