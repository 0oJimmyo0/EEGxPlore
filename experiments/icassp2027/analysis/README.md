...
After the 12 paper-facing cells finish, run:
...
The strict audit reads only the frozen FACED/ISRUC matrix from
`paper_table_manifest_v2.csv`. It rejects incomplete rows, seed 42, smoke
