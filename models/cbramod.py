...
class CBraMod(nn.Module):
    def __init__(
        ...
        moe_attnres_depth_block_separation_target_js: float = 0.03,
        ...
        moe_router_compact_warmup_epochs: int = 0,
        moe_router_compact_gate_init: float = 1.0,
...
def backbone_finetune_kwargs(param) -> Dict[str, Any]:
    ...
    return {
        ...
        'moe_attnres_depth_block_separation_target_js': getattr(param, 'moe_attnres_depth_block_separation_target_js', 0.03),
        ...
        'moe_router_compact_warmup_epochs': getattr(param, 'moe_router_compact_warmup_epochs', 0),
        'moe_router_compact_gate_init': getattr(param, 'moe_router_compact_gate_init', 1.0),
