...
class CBraMod(nn.Module):
    def __init__(
        ...
        moe_use_attnres_depth_router_concat: bool = False,
        moe_attnres_depth_router_dim: int = 4,
        moe_linear_router_input_norm: bool = False,
            ...
            for idx in range(n_layer):
                ...
                if idx >= moe_start:
                    moe_mod = TypedCapacityDomainMoEFFN(
                        ...
                        use_attnres_depth_router_concat=moe_use_attnres_depth_router_concat,
                        attnres_depth_router_dim=moe_attnres_depth_router_dim,
                        linear_router_input_norm=moe_linear_router_input_norm,
...
def backbone_finetune_kwargs(param) -> Dict[str, Any]:
    ...
    return {
        ...
        'moe_use_attnres_depth_router_concat': getattr(param, 'moe_use_attnres_depth_router_concat', False),
        'moe_attnres_depth_router_dim': getattr(param, 'moe_attnres_depth_router_dim', 4),
        'moe_linear_router_input_norm': getattr(param, 'moe_linear_router_input_norm', False),
