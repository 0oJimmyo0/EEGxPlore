...
class Model(nn.Module):
    def __init__(self, param):
        ...
        print(f"[FACED] moe_router_z_loss_coef = {getattr(param, 'moe_router_z_loss_coef', 0.0)}")
        print(f"[FACED] moe_router_jitter_std = {getattr(param, 'moe_router_jitter_std', 0.0)}")
        print(f"[FACED] moe_router_jitter_final_std = {getattr(param, 'moe_router_jitter_final_std', 0.0)}")
        print(f"[FACED] moe_router_jitter_anneal_epochs = {getattr(param, 'moe_router_jitter_anneal_epochs', 0)}")
